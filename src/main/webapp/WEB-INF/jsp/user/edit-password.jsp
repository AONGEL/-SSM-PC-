...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input[type="password"] { width: 100%; padding: 12px 16px; border: 1px solid #e0e0e0; border-radius: 8px; font-size: 15px; transition: all 0.3s ease; background: #fff; color: #121212; font-family: inherit; }
        input[type="password"]:focus { outline: none; border-color: #0066ff; box-shadow: 0 0 0 3px rgba(0,102,255,0.1); }
        .error { color: #dc3545; font-size: 13px; margin-top: 6px; display: block; font-weight: 500; }

        .password-strength { margin-top: 10px; font-size: 14px; font-weight: 500; padding: 10px 12px; border-radius: 8px; background: #fafafa; border-left: 4px solid #e0e0e0; }
        .password-strength.weak { border-left-color: #dc3545; }
        .password-strength.medium { border-left-color: #ffc107; }
        .password-strength.strong { border-left-color: #28a745; }
        ...
        <div class="card-body">
            ...
            <form:form action="${pageContext.request.contextPath}/user/update-password" method="post">
                <div class="form-group">
                    ...
                    <input type="password" id="oldPassword" name="oldPassword" required="required" placeholder="请输入当前密码"/>
                    <span class="error">${oldPasswordError}</span>
                </div>

                <div class="form-group">
                    <label for="newPassword">新密码</label>
                    <input type="password" id="newPassword" name="newPassword" required="required" placeholder="请输入新密码" onkeyup="checkPasswordStrength()"/>
                    <div class="password-strength" id="passwordStrength">
                        密码强度：<span id="strengthText" class="">未输入</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="confirmPassword" name="confirmPassword" required="required" placeholder="请再次输入新密码"/>
