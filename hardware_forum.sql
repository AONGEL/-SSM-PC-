...
INSERT INTO `certification_application` VALUES (45, 14, 'pending_discussion', '2026-04-15 20:24:05', 17, '{\"fill_blank_1\": \"xxxx\", \"fill_blank_2\": \"AAAA\", \"open_ended_3\": \"测试测试\", \"open_ended_4\": \"测试测试\", \"open_ended_5\": \"无\"}', '暂时不通过', '2026-04-18 00:35:59');
INSERT INTO `certification_application` VALUES (46, 13, 'rejected', '2026-04-18 00:41:01', 15, '{\"fill_blank_1\": \"\", \"fill_blank_2\": \"\", \"open_ended_3\": \"\", \"open_ended_4\": \"\", \"open_ended_5\": \"\"}', '', '2026-04-18 00:42:17');
INSERT INTO `certification_application` VALUES (47, 13, 'pending', '2026-04-18 00:46:55', 3, '{\"fill_blank_1\": \"\", \"fill_blank_2\": \"\", \"open_ended_3\": \"\", \"open_ended_4\": \"\", \"open_ended_5\": \"\"}', NULL, NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户通知表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `notifications` VALUES (21, 1, 'REPLY', 24, '2026-04-18 00:12:58', 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 79 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '参数引用表' ROW_FORMAT = Dynamic;
...
INSERT INTO `param_reference` VALUES (78, NULL, 84, 'gpu_info', 2, 'GeForce GTX 1060 6GB', '2026-04-17 17:07:57');
...
CREATE TABLE `post_favorite`  (
  ...
  INDEX `post_id`(`post_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '帖子收藏表' ROW_FORMAT = Fixed;
...
INSERT INTO `post_favorite` VALUES (35, 1, 24, '2026-04-18 18:22:44');
...
) ENGINE = MyISAM AUTO_INCREMENT = 88 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '回复表' ROW_FORMAT = Dynamic;
...
INSERT INTO `reply` VALUES (84, 24, 1, '123\r\n![](/uploads/20260417170746_450499af.png)\r\n[gpu_info:2]', '2026-04-17 17:07:57', NULL, 0);
INSERT INTO `reply` VALUES (85, 24, 3, '我觉得还是买5800X3D吧，反正复产了', '2026-04-18 00:12:58', NULL, 0);
INSERT INTO `reply` VALUES (86, 24, 1, '![](/uploads/20260418012121_d5f3103b.png)\r\n', '2026-04-18 01:21:38', NULL, 0);
INSERT INTO `reply` VALUES (87, 24, 1, '![](/uploads/20260418162631_113f8c7e.png)\r\n', '2026-04-18 16:26:44', NULL, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `user` VALUES (3, 'DORORO', '8dc4ad329ad18e849649e50f4c3feaf7', '2026-01-06 16:25:52', 'CERTIFIED', '/static/avatar/7.png', NULL);
...
INSERT INTO `user` VALUES (8, '测试4', '698d51a19d8a121ce581499d7b701668', '2026-01-09 22:36:57', 'USER', '/static/avatar/1.png', NULL);
INSERT INTO `user` VALUES (9, 'KY', '4297f44b13955235245b2497399d7a93', '2026-01-11 13:57:31', 'USER', '/static/avatar/1.png', NULL);
INSERT INTO `user` VALUES (15, '硬件用户', '8dc4ad329ad18e849649e50f4c3feaf7', '2026-04-18 00:47:28', 'USER', '/static/avatar/1.png', NULL);
